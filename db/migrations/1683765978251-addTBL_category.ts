...
export class AddTBLCategory1683765978251 implements MigrationInterface {
    name = 'AddTBLCategory1683765978251'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`roles\` varchar(255) NOT NULL DEFAULT 'user'`);
